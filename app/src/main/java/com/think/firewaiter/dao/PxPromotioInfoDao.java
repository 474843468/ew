...
/** 
 * DAO for table "PromotioInfo".
*/
public class PxPromotioInfoDao extends AbstractDao<PxPromotioInfo, Long> {

    public static final String TABLENAME = "PromotioInfo";

    /**
     * Properties of entity PxPromotioInfo.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Weekly = new Property(9, String.class, "weekly", false, "WEEKLY");
    ...
    public PxPromotioInfoDao(DaoConfig config) {
        super(config);
    }
    
    public PxPromotioInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PromotioInfo\" (" + //
                ...
                "\"WEEKLY\" TEXT," + // 9: weekly
                "\"DEL_FLAG\" TEXT);"); // 10: delFlag
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PromotioInfo\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PxPromotioInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(PxPromotioInfo entity) {
    ...
    /** @inheritdoc */
    @Override
    public PxPromotioInfo readEntity(Cursor cursor, int offset) {
        PxPromotioInfo entity = new PxPromotioInfo( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // weekly
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, PxPromotioInfo entity, int offset) {
        ...
        entity.setWeekly(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setDelFlag(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(PxPromotioInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(PxPromotioInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

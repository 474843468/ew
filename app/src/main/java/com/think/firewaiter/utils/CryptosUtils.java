...
public class CryptosUtils {
    ...
    private static final byte[] DEFAULT_KEY = new byte[]{-82, 22, 87, -63, -5, 54, -66, 111, -8, -93, -82, -117, 90, -30, -16, 74};
    ...
    public static String aesEncrypt(String input) {
        try {
            return EncodesUtils.encodeHex(aesEncrypt(input.getBytes(DEFAULT_URL_ENCODING), DEFAULT_KEY));
    ...
    public static String aesEncrypt(String input, String key) throws Exception {
        try {
            return EncodesUtils.encodeHex(aesEncrypt(input.getBytes(DEFAULT_URL_ENCODING), EncodesUtils.decodeHex(key)));
        } catch (UnsupportedEncodingException e) {
            return "";
        }
    }
    ...
    public static String aesDecrypt(String input) {
        try {
            return new String(aesDecrypt(EncodesUtils.decodeHex(input), DEFAULT_KEY), DEFAULT_URL_ENCODING);
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String aesDecrypt(String input, String key) {
        try {
            return new String(aesDecrypt(EncodesUtils.decodeHex(input), EncodesUtils.decodeHex(key)), DEFAULT_URL_ENCODING);
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String generateAesKeyString() {
        return EncodesUtils.encodeHex(generateAesKey(DEFAULT_AES_KEYSIZE));
    }
